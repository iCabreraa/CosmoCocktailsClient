    ...
    if (process.env.NODE_ENV === "development") {
      ...
      return {
        ...
        JWT_SECRET:
          ...
          "your_super_secret_jwt_key_that_is_at_least_32_characters_long_for_security",
        JWT_REFRESH_SECRET:
          process.env.JWT_REFRESH_SECRET ||
          "your_super_secret_refresh_key_that_is_at_least_32_characters_long_for_security",
