-- Script final para corregir todos los problemas identificados
-- Ejecutar este SQL en el SQL Editor del dashboard de Supabase

-- 1. Actualizar el RPC para crear pedidos directamente con estado "ordered"
...
-- 2. Verificar que la restricción de estados permite "ordered"
...
-- 3. Actualizar pedidos existentes con estado "paid" a "ordered"
UPDATE public.orders
SET status = 'ordered'
WHERE status = 'paid';

-- 4. Verificar que todo funciona
SELECT 'RPC y restricciones actualizadas correctamente' as status;
